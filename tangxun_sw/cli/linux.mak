...
# Jiutai source files
JIUTAI_SRCS = fixdata.c datastat.c regression.c indicator.c statarbitrage.c damethod.c tx_env.c
...
EXTRA_LIBS = -ljf_logger -ljf_files -ljf_clieng -ljf_string -ljf_ifmgmt \
    ...
    -ltx_trade -ltx_rule -ltx_model -ltx_trade_persistency -ltx_backtesting -ltx_parsedata \
    -ltx_stock -ltx_download -lm -lsqlite3
